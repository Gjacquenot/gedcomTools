...
# of family names: it uppers case the family name.
# The result is exported in a new file.
#
# This script does not require any additional library to work.

def upperCaseName(gedcomFilename, outputFilename = None):
    """
...
if __name__ == '__main__':
    ...
    upperCaseName(gedcomFilename = args.gedcom, outputFilename = args.outputGedcom)
